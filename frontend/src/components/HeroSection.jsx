      ...
      <div className="container mx-auto px-4 pt-8" >
        ...
        >
          <h1 className="text-5xl md:text-8xl font-bold mb-6 text-center">
            Shaping the <p className='inline text-orange-400 bg-clip-text text-transparent'>Future</p> with <p className='inline bg-green-400 bg-clip-text text-transparent invert'>Next-Gen</p> Digital Solutions
          </h1>
